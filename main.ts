/*This project is a simple console based Student Management System. This project  will add new students, generate a 5 digit 
unique studentID for each student, how to enroll students in the given courses. Also,will implement the following operations enroll,
 view balance, pay tuition fees, show status, etc. The status will show all the details of the student including name, id, 
 courses enrolled and balance.It is one of the best projects to implement the Object Oriented Programming concepts.*/
//  #! /usr/bin/env node
...
async function enrollStudent() {
  ...
  if (StudentDetails.Details === "Enroll") {
    ...
    const course: Course | undefined = courses.find((course) => course.name === answer2.course);
   ...
   let balance = answer3.balance;
    if (course) {
      ...
      let student: Student | undefined = students.find((student) => student.name === answer.name);
